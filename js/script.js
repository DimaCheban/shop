...
// Render main and categoriesContainer
 ...
 const renderProductInTabele = () => {
		...
		user.favourites.forEach(favId => {
				...
				PRODUCTS.forEach(product => {
					...
					// productBlock.className = `data-id-fav="${product.id}"`;
...
// Delete and paste image and id in array
...
// Delete and paste image and id in array in favourites Items
